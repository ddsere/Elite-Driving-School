...
import lk.ijse.elitedrivingschool.tm.LessonTm;
...
public class LessonController implements Initializable {
    ...
    private static final String TEXT_FIELD_STYLE = "-fx-background-color: #f0f8ff; -fx-background-radius: 8; -fx-border-radius: 8; -fx-border-color: #87ceeb; -fx-padding: 10; -fx-font-size: 14; -fx-text-fill: #0d1a2f;";
    private static final String COMBO_BOX_STYLE = "-fx-background-color: #f0f8ff; -fx-background-radius: 8; -fx-border-radius: 8; -fx-border-color: #87ceeb; -fx-padding: 10; -fx-font-size: 14; -fx-text-fill: #0d1a2f;";
    private static final String DATE_PICKER_STYLE = "-fx-background-color: #f0f8ff; -fx-background-radius: 8; -fx-border-radius: 8; -fx-border-color: #87ceeb; -fx-font-size: 14; -fx-text-fill: #0d1a2f;";
    ...
    private void applyStyles() {
        txtId.setStyle(TEXT_FIELD_STYLE);
        txtId.setEditable(false);
        txtStudentId.setStyle(TEXT_FIELD_STYLE);
        txtStartTime.setStyle(TEXT_FIELD_STYLE);
        cmbCourse.setStyle(COMBO_BOX_STYLE);
        cmbInstructor.setStyle(COMBO_BOX_STYLE);
        DatePiker.setStyle(DATE_PICKER_STYLE);
    }
    ...
    void btnSaveOnAction(ActionEvent event) {
        try {
            ...
            LessonDto lessonDto = new LessonDto(null, studentId, instructorId, courseId, scheduledTime, "SCHEDULED");
    ...
    void btnUpdateOnAction(ActionEvent event) {
        try {
            ...
            LessonDto lessonDto = new LessonDto(lessonId, studentId, instructorId, courseId, scheduledTime, "SCHEDULED");
